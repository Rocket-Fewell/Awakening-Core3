...
#ifndef NPCUNARMEDCOMBO2COMMAND_H_
#define NPCUNARMEDCOMBO2COMMAND_H_

#include "CombatQueueCommand.h"

class NpcUnarmedCombo2Command : public CombatQueueCommand {
public:

	NpcUnarmedCombo2Command(const String& name, ZoneProcessServer* server)
...
#endif //NPCUNARMEDCOMBO2COMMAND_H_
