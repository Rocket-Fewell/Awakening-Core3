...
void AwakeningLogManagerImplementation::initialize() {
	...
	//Staff Credit Trade Log
	staffCreditTradeLog.setLoggingName("Staff Credit Trade Log");
	staffCreditTradeLog.setFileLogger("log/staff/creditTrade.log", true);
	staffCreditTradeLog.setLogging(true);
	...
	//Loot Log
	lootLog.setLoggingName("Loot Log");
	lootLog.setFileLogger("log/player/loot.log", true);
